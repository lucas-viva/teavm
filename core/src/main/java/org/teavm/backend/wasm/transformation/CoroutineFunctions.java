...
class CoroutineFunctions {
    ...
    WasmFunction isResuming() {
        if (isResumingCache == null) {
            isResumingCache = functions.forStaticMethod(new MethodReference(Fiber.class, "isResuming",
    ...
    WasmFunction isSuspending() {
        if (isSuspendingCache == null) {
            isSuspendingCache = functions.forStaticMethod(new MethodReference(Fiber.class, "isSuspending",
                    Fiber.class, boolean.class));
        }
